...
const Ecomm = () => {
  ...
  const stats = [
    { value: 8, label: "tech projects in the E-commerce industry delivery", suffix: "+" },
    { value: 10, label: "specialists in the E-commerce industry", suffix: "+" },
    { value: 8, label: "years of expertise in the business", suffix: " years" },
    { value: 4.85, label: "review rating based on 55+ reviews", decimals: 2, suffix: "/5 " },
  ];

 const content = {
   heading: "E-COMMERCE SOFTWARE DEVELOPMENT",
  subheading:
    "Witness swift collaboration of technology and innovation in the e-commerce sector only at Go InfoTech for the exponential growth of your business.",
 };
     ...
     const whitecardsData = [
  {
    ...
    description: [
      'We offer comprehensive software solutions that are custom-developed to meet your specific e-commerce business requirements.',
   ...
   //  titlePath: '/services/finance',
    description: [
      'Explore the expertise of our professionals, offering high-quality performance and scalability in the e-commerce software solutions offered at Go InfoTech.',
  ...
  },
   {
    ...
    // titlePath: '/services/finance',
    description: [
      'We partner with updated technology tools to elevate performance and drive sales. We make use of AI, blockchain, and data analytics for effective management of e-commerce operations.',
  ...
  },
   {
    ...
    // titlePath: '/services/finance',
    description: [
      'At Go InfoTech, we value your credibility, which is why we prioritize security in our e-commerce software solutions while simultaneously focusing on regulatory compliance.',
  ...
  },
  {
    ...
    // titlePath: '/services/finance',
    description: [
      'We offer scalable e-commerce solutions for facilitating seamless transactions and the integration of social media platforms while offering a compatible and interactive interface.',
  ...
  },
  {
    ...
    // titlePath: '/services/finance',
    description: [
      'We believe in offering real-time support and assistance to our clients while paying deliberate attention to the unique needs and requirements of e-commerce businesses.',
...
const methodologyData = [
  {
    ...
    description:
      'We take pride in our professional developers, designers, and specialists who have delivered excellence in e-commerce software solutions customized to their unique online business needs.',
  },
  {
    icon: <Lightbulb size={20} />,
    title: 'ONLINE RETAILERS',
    description:
      'We meticulously crafted a powerful, security-rich IT solution for several online retailers to elevate their user experience while incorporating innovation into the e-commerce platform.',
  },
  {
    icon: <Lock size={20} />,
    title: 'MULTI-CHANNEL E-COMMERCE PLATFORMS',
    description:
      'Empowering multi-channel e-commerce platforms by unleashing the power of technology and innovation and providing solutions that are feature-rich, scalable, user-friendly, and safe to use.',
  },
   {
    icon: <Lock size={20} />,
    title: 'E-COMMERCE SOLUTION PROVIDERS',
    description:
